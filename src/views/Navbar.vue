<template>
    ...
    <div style="color:white;">
        <div style="background-color:black; display:flex;" class="container-fluid">
            ...
            <form style="align-items:center; margin-left:100px;" class="d-flex">
            ...
            <router-link to="admin/products"><button style="height:40px;width:80px; margin: 34px 0 0 10px" class="btn btn-outline-success"><fa :icon="['fas','dashboard']"/></button></router-link>
