<template>
  <section>
    <div style="color:black; background-color:white;" class="about-section">
      <h1 style="text-align:start">About Us</h1>
      <hr style="border: 2px solid gray">
      <h2 style="margin-top:30px" >Our Mission</h2>
      <p style=" text-align:justify; padding:40px 50px 50px 50px">
...
Because of the complexity of the work on the ground and the evolving security landscape, technology assistance can have an outsized impact on the success of relief efforts. This is why AWS is committing $15 million in cloud computing credits, and technical expertise, to continue supporting local and global organizations addressing this humanitarian crisis. Existing customers that would like to access these resources to further their efforts should reach out to their account managers, while new customers can get started here.
    ...
    <div class="row">
      <div class="column">
        <div class="card">
          <img :src="'https://www.biography.com/.image/t_share/MTc5OTk2ODUyMTMxNzM0ODcy/gettyimages-1229892983-square.jpg'" height="300px" alt="Jane" style="width: 100%" />
          <div class="container">
            <h2>Elon Maksuti</h2>
            <p class="title">CEO & Founder</p>
            <p>Some text that describes me lorem ipsum ipsum lorem.</p>
            <p>elon@example.com</p>
      ...
      <div class="column">
        <div class="card">
          <img :src="'https://api.time.com/wp-content/uploads/2018/09/bill-gates-africa.jpg'" height="300px" alt="Mike" style="width: 100%" />
          <div class="container">
            <h2>Bill Geci</h2>
      ...
      <div class="column">
        <div class="card">
          <img :src="'https://www.success.com/wp-content/uploads/2018/07/JeffBezos_SecretstoSuccess-1-1024x682.jpg'" alt="Mike" style="width: 100%" height="300px" />
          <div class="container">
            <h2>Jeff Berisha</h2>
